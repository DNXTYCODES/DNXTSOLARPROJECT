...
const Admin = () => {
  ...
  // Alternative to .map() for rendering users using forEach
  const renderUsers = () => {
    const userElements = [];
    users.forEach((user) => {
      userElements.push(
        <tr key={user.id}>
          ...
          <td>
            <ul>
              {user.favResidenciesID.forEach((productId, index) => {
                userElements.push(<li key={index}>{productId}</li>);
              })}
            </ul>
          </td>
          <td>
            <ul>
              {user.bookedVisits.forEach((visit, index) => {
                userElements.push(<li key={index}>{visit.date}</li>);
              })}
            </ul>
          </td>
        </tr>
  ...
  // Alternative to .map() for rendering products using forEach
